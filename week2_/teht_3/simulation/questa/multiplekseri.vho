...
-- valitsin	=>  Location: PIN_F15,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF multiplekseri IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
SIGNAL ww_devclrn : std_logic;
SIGNAL ww_devpor : std_logic;
SIGNAL ww_valitsin : std_logic;
SIGNAL ww_kytkin : std_logic_vector(1 DOWNTO 0);
...
SIGNAL \valitsin~input_o\ : std_logic;
...
\valitsin~input\ : fiftyfivenm_io_ibuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	listen_to_nsleep_signal => "false",
...
-- Equation(s):
-- \Mux0~0_combout\ = (\valitsin~input_o\ & (\kytkin[0]~input_o\)) # (!\valitsin~input_o\ & ((\kytkin[1]~input_o\)))
...
PORT MAP (
	...
	datac => \kytkin[1]~input_o\,
	datad => \valitsin~input_o\,
